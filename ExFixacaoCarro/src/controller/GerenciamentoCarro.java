...
public class GerenciamentoCarro {
	...
	/*	String resposta = c1.situacaoMotor(); //se quiser guardar esse valor
		...
		//situação obj 1
		System.out.println(c1.situacaoMotor()); //para só mostrar a resposta
		...
		//situação obj 2
		System.out.println(c2.situacaoMotor()); //para só mostrar a resposta
		...
		//situação obj 3
		System.out.println(c3.situacaoMotor()); //para só mostrar a resposta
